...
insert into FUNCIONARIO(profissao_codigo,nome,endereco,FILIAL_codigo) values('4','Renata Almeida Macedo','Av. dos Trabalhadores, 125 Bloco B','2');insert into FUNCIONARIO(profissao_codigo,nome,endereco,FILIAL_codigo) values('3','Felic','','');
