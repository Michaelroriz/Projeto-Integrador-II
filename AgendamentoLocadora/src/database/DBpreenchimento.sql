...
insert into STATUS(codigo,descricao) value(1,'Disponível');
insert into STATUS(codigo,descricao) value(2,'Reservado');

insert into MOTIVO(codigo,descricao) values
(1,'Agendado com sucesso'),
